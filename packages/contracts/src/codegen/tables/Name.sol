...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_OFFCHAIN_TABLE, bytes14(""), bytes16("Name")))
);
...
library Name {
   ...
   */
  function set(address artist, string memory value) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(address artist, string memory value) internal {
    bytes memory _staticData;
    PackedCounter _encodedLengths = encodeLengths(value);
    bytes memory _dynamicData = encodeDynamic(value);
